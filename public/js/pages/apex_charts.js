...
document.addEventListener("DOMContentLoaded", function() {
	...
	var options = {
		...
		colors: ["#da224f", "#51ce8a", "#00baff", "#f2426d", "#fec801"],
		tooltip: {
			y: {
				formatter: function(val) {
					return val + "K"
...
document.addEventListener("DOMContentLoaded", function() {
	...
	var options = {
		...
		colors: ["#51ce8a", "#da224f", "#f2426d", "#fec801"],
		series: [44, 55, 13, 33]
	}
	var chart = new ApexCharts(
