...
// // app.use(helmet());
// // Set security HTTP Headers including Content Security Policy (CSP)
// app.use(
//   helmet.contentSecurityPolicy({
//     directives: {
//       defaultSrc: ["'self'"],
//       scriptSrc: ["'self'", 'https://conoret.com'],
//       // Add other directives as per your requirements
//     },
//   })
// );
// // Set Content Security Policy (CSP) in the HTTP response headers
// app.use((req, res, next) => {
//   res.setHeader(
//     'Content-Security-Policy',
//     "script-src 'self' https://conoret.com 'unsafe-inline';"
//   );
//   next();
// });
